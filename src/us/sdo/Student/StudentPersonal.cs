...
public class StudentPersonal : SifDataObject
{
	...
	/// </summary>
	public StudentPersonal() : base( SifVersion.LATEST, StudentDTD.STUDENTPERSONAL ){}
	...
	///
	public StudentPersonal( string refId, Name name ) : base( SifVersion.LATEST, StudentDTD.STUDENTPERSONAL )
	{
		this.RefId = refId;
		this.Name = name;
	}
...
// BEGIN EXTRA METHODS (C:/GitHub/rafidzal/OpenADK-java/adk-generator/../adk-generator/datadef/us/sif20/StudentPersonal.txt.cs)
 ...
 /// <summary>
    ...
    /// to the StudentPersonal object by calling the <see cref="StudentAddressList.AddAddress(AddressType, Street, string, StatePrCode, CountryCode, string)"/> method
    /// </para>
    /// </remarks>
    ...
    ///  <see cref="StudentAddressList.StudentAddressList()"/> property
    /// </summary>
    /// <returns></returns>
