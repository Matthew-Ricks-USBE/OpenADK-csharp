...
public class StaffAssignment : SifDataObject
{
	...
	///
	public StaffAssignment( string refId, string schoolInfoRefId, int? schoolYear, string staffPersonalRefId, YesNo primaryAssignment ) : base( SifVersion.LATEST, StudentDTD.STAFFASSIGNMENT )
	{
		this.RefId = refId;
